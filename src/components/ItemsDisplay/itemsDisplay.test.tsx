...
describe("Items Display", () => {
  it("loads and displays no item display", async () => {
    render(
  ...
  it("loads and displays item display", async () => {
    render(
      <ThemeProvider theme={theme}>
  ...
  it("item description is initially invisible", async () => {
    render(
      <ThemeProvider theme={theme}>
        <ItemsDisplay items={testItems} />
      </ThemeProvider>,
  ...
  // it("item description is visible on hover", async () => {
  //   render(
  //     <ThemeProvider theme={theme}>
  //       <ItemsDisplay items={testItems} />
  //     </ThemeProvider>,
