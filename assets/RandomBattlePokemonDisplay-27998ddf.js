import{s as a,D as b,j as s,a as n,c as g,P as D,f as $,T as j,F as l,r as p}from"./index-1b453c5d.js";import{b as u,c as y,H as P,h as B,d as x,T as v,A as C}from"./PokemonDataDisplay-b514a3e7.js";const I=a(u)``,O=b.data.Items,k=({items:e})=>s(I,{children:[n("h3",{children:"Items:"}),e?e.map(t=>s(y,{children:[t,n(P,{children:O[g(t)].desc})]},t)):n(y,{children:"None"})]}),w=a(P)``,T=a(j)`
  position: relative;
  ${B}
  ${D}
