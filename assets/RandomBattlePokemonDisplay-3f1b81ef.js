import{s as o,D as g,j as s,a as n,c as P,P as $,f as T,T as j,F as l,r as p}from"./index-dc332e9a.js";import{b as m,c as f,H as x,h as B,d as k,T as v,A as C}from"./PokemonDataDisplay-4cc10d6f.js";const I=o(m)``,O=g.data.Items,w=({items:e})=>s(I,{children:[n("h3",{children:"Items:"}),e?e.map(t=>s(f,{children:[n("span",{children:t}),n(x,{children:O[P(t)].desc})]},t)):n(f,{children:"None"})]}),R=o(x)``,z=o(j)`
  position: relative;
  ${B}
  ${$}
